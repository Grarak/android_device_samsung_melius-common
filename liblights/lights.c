...
const char *const PANEL_FILE = "/sys/devices/platform/mipi_novatek_nt35596.2049/lcd/panel/panel/brightness";
const char *const BUTTON_FILE = "/sys/devices/i2c-3/3-0020/leds/button-backlight/brightness";
